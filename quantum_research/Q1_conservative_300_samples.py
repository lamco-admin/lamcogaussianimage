"""
Q1: Quantum Channel Discovery - CONSERVATIVE (300 samples)

MEMORY REQUIREMENTS:
- VM RAM: 22GB (CURRENT VM - NO RESIZE NEEDED)
- Quantum Memory: 2.6GB
- Headroom: 19.4GB
- Runtime: <1 minute
- Status: SAFE, works with current configuration ✓

This version runs safely on your current 22GB VM without any changes.
300 samples is sufficient for channel discovery, though with slightly
lower statistical confidence than 500 or 1,100 samples.
"""
...
print("=" * 80)
print("Q1: QUANTUM GAUSSIAN CHANNEL DISCOVERY - CONSERVATIVE (300 samples)")
print("=" * 80)
print()
print("Memory Configuration:")
print("  VM RAM Required: 22GB (current VM ✓)")
print("  Quantum Memory: ~2.6GB peak")
print("  Headroom: ~19.4GB (very safe)")
...
# Type 1: Small elongated (edge attempts) - 75 samples
...
# Type 2: Large isotropic (successful interior) - 75 samples
...
# Type 3: Medium isotropic (background) - 75 samples
...
# Type 4: Parameter sweep variations - 75 samples
...
# Save results
results = {
    'experiment': 'Q1_conservative_300',
    ...
    'memory_config': {
        'vm_ram_required_gb': 22,
        'quantum_peak_memory_gb': 2.6,
        'headroom_gb': 19.4
    }
}

output_file = 'gaussian_channels_300_samples.json'
...
print("=" * 80)
print()
print("1. If results look promising:")
print("   - Consider running 500-sample version (requires 32GB VM)")
print("   - Or 1,100-sample version (requires 45GB VM)")
print("   - Higher sample counts increase statistical confidence")
print()
...
print("Quality: Good for initial discovery (300 samples)")
print()
print("=" * 80)
